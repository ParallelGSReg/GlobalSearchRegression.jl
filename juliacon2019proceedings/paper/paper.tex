...
%%%%%%%%%%%%%%%%%% Figure 1
\begin{figure}[h]
\centerline{\includegraphics[width=10cm]{paper/Images/flowchart.png}}
...
\begin{figure*}[!t]
  \begin{subfigure}
    \centering
    \includegraphics[width=5.5cm]{paper/Images/juliatime.png}
  \end{subfigure}
    \centering
  \begin{subfigure}
    \includegraphics[width=5.5cm]{paper/Images/statatime.png}
  \end{subfigure}
    \centering
  \begin{subfigure}
    \includegraphics[width=5.5cm]{paper/Images/rtime.png}
  \end{subfigure}
  \vspace{2mm}
...
\begin{figure*}[!t]
\centering
    \includegraphics[width=16cm]{paper/Images/juliaexe.PNG}  
    \vspace{2mm}
